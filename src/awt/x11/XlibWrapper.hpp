...
public:
	...
	static void XNextEvent(long display,long ptr);
	...
	static boolean XFilterEvent(long ptr, long window);
	...
	static int XTranslateCoordinates(
                                             ...
                                             long child_return);
	static void XPeekEvent(long display,long ptr);
    ...
    static void SetProperty(long display, long window, long atom, String str);
   ...
   static void XChangePropertyImpl(long display, long window, long atom,
    ...
    static String XGetDefault(long display, String program, String option);
    ...
    static boolean XQueryExtension(long display, String name, long mop_return,
